defmodule NervesSystemWebcamDebug.MixProject do
  use Mix.Project
  ...
  defp nerves_package do
    [
      type: :system,
      artifact_sites: [
        {:github_releases, "RickCarlino/system_webcam_debug"}
      ],
  ...
  defp description do
    """
    Nerves System - Rick Carlino debugging RPi0 Webcam issues in isolation.
    """
  end
  ...
  defp package do
    [
      files: package_files(),
      licenses: ["Apache 2.0"],
      links: %{"GitHub" => "https://github.com/RickCarlino/system_webcam_debug"}
    ]
  end
